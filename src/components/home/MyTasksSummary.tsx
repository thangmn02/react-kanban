  ...
  return (
    <div className="grid gap-3 border-b border-slate-100 px-5 py-4 sm:grid-cols-3">
      <div className="rounded-2xl bg-amber-50 px-4 py-3">
        <Typography component="p" content="Due today" className="text-[11px] font-semibold uppercase tracking-[0.16em] text-amber-600" />
        <Typography component="p" content={String(dueTodayCount)} className="mt-1 text-2xl font-semibold text-amber-900" />
      </div>
      <div className="rounded-2xl bg-rose-50 px-4 py-3">
        <Typography component="p" content="Overdue" className="text-[11px] font-semibold uppercase tracking-[0.16em] text-rose-600" />
        <Typography component="p" content={String(overdueCount)} className="mt-1 text-2xl font-semibold text-rose-900" />
      </div>
      <div className="rounded-2xl bg-slate-50 px-4 py-3">
        <Typography component="p" content="No date" className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500" />
